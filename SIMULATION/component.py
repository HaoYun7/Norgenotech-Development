...
class Component:
    def __init__(self):
        ...
        self.right_bar_location = vector(0, -1, 2.25)
        ...
        self.left_bar_location = vector(0, -1, -2.25)
    ...
    def build_robot(self):
        ground = self.set_ground()
        right_bar = self.set_right_bar()
        left_bar = self.set_left_bar()
        mid_bar = self.set_mid_bar()
        hand = self.set_hand()
        finger = self.set_finger()
